        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
              Tu Vision, Nuestra{' '}
              <span className="text-orange-500">Prioridad</span>
            </h1>
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              Servicios profesionales de cuidado ocular con tecnología de vanguardia.
              Exámenes oculares completos, consultas con expertos y soluciones ópticas personalizadas.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              <button
                onClick={scrollToBooking}
                className="bg-orange-500 text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-orange-600 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
                Haz tu cita!
              </button>
              <button
            ...
            <div className="grid grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600 font-medium">Agenda tu chequeo visual en linea</p>
              </div>
              <div className="text-center">
                <div className="bg-teal-100 p-3 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-3">
                  <Shield className="h-8 w-8 text-teal-500" />
                </div>
                <p className="text-sm text-gray-600 font-medium">Profesionales de la salud</p>
              </div>
              <div className="text-center">
                <div className="bg-orange-100 p-3 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-3">
                  <Users className="h-8 w-8 text-orange-500" />
                </div>
                <p className="text-sm text-gray-600 font-medium">5000+ Pacientes atendidos</p>
              </div>
            </div>
          </div>

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Professional eye care services with over 15 years of experience. 
          ...
          <div>
            ...
            <div className="space-y-3 mb-8">
              <div className="flex items-center text-gray-300">
                <Clock className="h-4 w-4 mr-3 text-sky-400" />
        ...
        <div className="border-t border-gray-800 pt-8 mt-12">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              © 2025 VisionCare. All rights reserved.
            </p>
        ...
        <div className="mt-8 bg-red-900/20 border border-red-800 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div>
              <h4 className="font-semibold text-red-200 mb-1">24/7 Emergency Eye Care</h4>
              <p className="text-red-300 text-sm">For urgent eye injuries or sudden vision changes</p>
            </div>
            <a 
